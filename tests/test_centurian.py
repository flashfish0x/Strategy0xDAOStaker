...
def test_centurian_live(Contract, accounts, whale, wftm, GenericMasterChefStrategy, chain):
    masterchef = Contract("0xCf3cf18B70CF423a83DB7E122bC42347aFB9642A")
    pid = 0
    emissionToken = Contract("0x454c753D29d1AC7A61959F0842dE69B93D10DBE1")
